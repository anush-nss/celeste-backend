...
from src.shared.constants import OrderStatus
...
class OrderService:
    ...
    async def create_order(self, order_data: CreateOrderSchema, user_id: str) -> OrderSchema:
    ...
    async def update_order(self, order_id: str, order_data: UpdateOrderSchema) -> OrderSchema | None:
