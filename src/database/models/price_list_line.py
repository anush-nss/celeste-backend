...
class PriceListLine(Base):
    ...
    min_order_amount: Mapped[Optional[Decimal]] = mapped_column(
        DECIMAL(10, 2), nullable=True
    )  # NULL = no minimum order requirement
    ...
    __table_args__ = (
        CheckConstraint(
            "discount_type IN ('percentage', 'flat', 'fixed_price')",
            name="check_discount_type",
        ),
        CheckConstraint(
            "discount_value >= 0", name="check_discount_value_non_negative"
        ),
        CheckConstraint("min_quantity >= 1", name="check_min_quantity_positive"),
        CheckConstraint(
            "min_order_amount >= 0", name="check_min_order_amount_non_negative"
        ),
        # Core pricing lookup indexes
        Index(
            "idx_price_list_lines_list_active",
            "price_list_id",
            "is_active",
            postgresql_where="is_active = true",
        ),
        Index(
            "idx_price_list_lines_covering",
            "price_list_id",
            "is_active",
            "min_quantity",
            "discount_type",
        ...
        Index(
            "idx_price_list_lines_product_active",
            "product_id",
            "price_list_id",
            "is_active",
        ...
        Index(
            "idx_price_list_lines_product_quantity",
            "product_id",
            "min_quantity",
            "discount_value",
            postgresql_where="product_id IS NOT NULL AND is_active = true",
        ...
        Index(
            "idx_price_list_lines_category_active",
            "category_id",
            "price_list_id",
            "is_active",
        ...
        Index(
            "idx_price_list_lines_category_quantity",
            "category_id",
            "min_quantity",
            "discount_value",
            postgresql_where="category_id IS NOT NULL AND is_active = true",
        ...
        Index(
            "idx_price_list_lines_quantity_discount",
            "min_quantity",
            "discount_type",
            "discount_value",
        ),
        Index(
            "idx_price_list_lines_min_order",
            "min_order_amount",
        ...
        Index(
            "idx_price_list_lines_full_lookup",
            "price_list_id",
            "product_id",
            "category_id",
            "min_quantity",
        ...
        Index(
            "idx_price_list_lines_priority_lookup",
            "price_list_id",
            "is_active",
            "product_id",
            "category_id",
