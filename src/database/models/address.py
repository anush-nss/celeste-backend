...
from sqlalchemy import Integer, String, Boolean, Float, ForeignKey, CheckConstraint, Index
...
class Address(Base):
    ...
    user_id: Mapped[str] = mapped_column(String(128), ForeignKey('users.firebase_uid', ondelete='CASCADE'), nullable=False, index=True)
