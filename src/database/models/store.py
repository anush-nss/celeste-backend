...
class Store(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "latitude >= -90 AND latitude <= 90", name="check_latitude_bounds"
        ),
        CheckConstraint(
            "longitude >= -180 AND longitude <= 180", name="check_longitude_bounds"
        ),
