...
class Product(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_products_ecommerce_category', 'ecommerce_category_id', postgresql_where="ecommerce_category_id IS NOT NULL"),

        # Composite indexes for complex queries
        Index('idx_products_price_range_pagination', 'base_price', 'id'),
        Index('idx_products_category_price_id', 'ecommerce_category_id', 'base_price', 'id',
        ...
        Index('idx_products_brand_price', 'brand', 'base_price', postgresql_where="brand IS NOT NULL"),
        Index('idx_products_brand_category', 'brand', 'ecommerce_category_id',
...
class Tag(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_tags_slug', 'slug', unique=True, postgresql_where="slug IS NOT NULL"),
        Index('idx_tags_active', 'is_active', 'tag_type', postgresql_where="is_active = true"),
        Index('idx_tags_type_active_name', 'tag_type', 'is_active', 'name', postgresql_where="is_active = true"),

        # Search indexes
        Index('idx_tags_name_trgm', 'name', postgresql_using='gin', postgresql_ops={'name': 'gin_trgm_ops'}),
    )
...
class ProductTag(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_product_tags_tag_value', 'tag_id', 'value', postgresql_where="value IS NOT NULL"),
    )
