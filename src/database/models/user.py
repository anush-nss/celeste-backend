...
class User(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_users_email_unique', 'email', unique=True, postgresql_where="email IS NOT NULL"),
        ...
        Index('idx_users_tier_lifetime_value', 'tier_id', 'lifetime_value',
              postgresql_where="tier_id IS NOT NULL"),
        Index('idx_users_tier_total_orders', 'tier_id', 'total_orders',
              postgresql_where="tier_id IS NOT NULL"),

        # Delivery and logistics indexes
        Index('idx_users_is_delivery', 'is_delivery', postgresql_where="is_delivery IS NOT NULL"),
        Index('idx_users_delivery_active', 'is_delivery', 'role',
              postgresql_where="is_delivery = true"),

        # Activity and engagement indexes
        Index('idx_users_last_order_at', 'last_order_at',
        ...
        Index('idx_users_name_trgm', 'name', postgresql_using='gin', postgresql_ops={'name': 'gin_trgm_ops'}),
        ...
        Index('idx_users_role_lifetime_orders', 'role', 'lifetime_value', 'total_orders'),
        Index('idx_users_active_high_value', 'tier_id', 'lifetime_value', 'last_order_at',
