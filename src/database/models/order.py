...
class Order(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_orders_composite_listing', 'user_id', 'status', 'created_at', 'total_amount'),
        Index('idx_orders_store_composite', 'store_id', 'status', 'created_at', 'total_amount'),
...
class OrderItem(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_order_items_full_analysis', 'order_id', 'product_id', 'quantity', 'unit_price', 'total_price'),
    )
