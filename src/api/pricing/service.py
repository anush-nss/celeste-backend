...
class PricingService:
    ...
    async def calculate_product_pricing(
        ...
        pricing_cache.set_product_pricing(
            product_id or "none", base_price, category_id, customer_tier, result, quantity
        )
    ...
    async def calculate_bulk_product_pricing(
        ...
        valid_price_lists = [pl for pl in active_price_lists if self.is_price_list_valid(pl)]
        ...
        for product in products:
            ...
            if not product_id:
                results.append(self.create_base_pricing_result(base_price, customer_tier))
                continue
