...
class CacheConfig:
    ...
    PRODUCT_PRICING_TTL = int(os.getenv('CACHE_PRODUCT_PRICING_TTL', '300'))  # 5 minutes
    ...
    PRICE_LIST_LINES_TTL = int(os.getenv('CACHE_PRICE_LIST_LINES_TTL', '600'))  # 10 minutes
    ...
    CLEANUP_INTERVAL_MINUTES = int(os.getenv('CACHE_CLEANUP_INTERVAL', '5'))  # 5 minutes
